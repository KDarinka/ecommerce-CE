...
class VariationManager(models.Manager):
    def complemento(self):
        return super(VariationManager, self).filter(variation_category='complementos', is_active=True)
    def medidas(self):
        return super(VariationManager, self).filter(variation_category='medida', is_active=True)
    def sabores(self):
